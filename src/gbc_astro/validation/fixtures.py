"""Deterministic validation fixtures used when real providers are unnecessary."""
...
class DeterministicValidationProvider:
    id = "deterministic-validation-fixture"
...
class DeterministicValidationHouseCalculator:
    id = "deterministic-validation-house"
